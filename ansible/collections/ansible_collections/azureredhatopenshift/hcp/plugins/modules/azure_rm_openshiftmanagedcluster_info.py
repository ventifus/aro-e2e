...
DOCUMENTATION = """
---
module: azure_rm_openshifthcpcluster_info
version_added: '1.11.0'
short_description: Get Info for Azure Red Hat OpenShift HCP Cluster
description:
...
EXAMPLES = """
- name: List all Azure Red Hat OpenShift HCP Clusters for a given subscription
  azure_rm_openshifthcpcluster_info:
- name: List all Azure Red Hat OpenShift HCP Clusters for a given resource group
  azure_rm_openshifthcpcluster_info:
    resource_group: myResourceGroup
- name: Get Azure Red Hat OpenShift HCP Clusters
  azure_rm_openshifthcpcluster_info:
    resource_group: myResourceGroup
...
class AzureRMopenshifthcpclustersInfo(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            resource_group=dict(type="str"),
            name=dict(type="str"),
            rp_mode=dict(type="str", choices=["production", "development"]),
        ...
        self.mgmt_client = None
        super(AzureRMopenshifthcpclustersInfo, self).__init__(
    ...
    def listall(self):
        ...
        # prepare url
        self.url = path.join(
            "subscriptions", self.subscription_id, "providers", "Microsoft.RedHatOpenShift", "hcpOpenShiftclusters"
        )
...
def main():
    AzureRMopenshifthcpclustersInfo()
